...
struct ActiveDevicesViewOld: View {
...
//    @State var activeDevices: [ActiveSessions] = []
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationBarTitle("Active Devices", displayMode: .large)
        ...
        .actionSheet(isPresented: $showLogoutSheet) {
            ActionSheet(
                title: Text("Logout Device").font(Font.custom("Urbanist", size: 16.0)),
                message: Text("Are you sure you want to logout \(allDevices ? "All Devices" : "\"\(deviceName)\"" )? ").font(Font.custom("Urbanist", size: 13.0)),
                buttons: [
                    .default(Text("Yes").font(Font.custom("Urbanist", size: 14.0)), action: {
                    ...
                    .cancel(Text("No").font(Font.custom("Urbanist", size: 14.0)), action: {
...
struct ActiveDevicesViewOld_Previews: PreviewProvider {
    static var previews: some View {
        ActiveDevicesViewOld()
    }
}
