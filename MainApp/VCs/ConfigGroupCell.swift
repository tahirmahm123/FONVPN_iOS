...
class ConfigGroupCell: UITableViewCell {
    ...
    func config(_ group: ConfigurationGroup, hintColor: UIColor) {
        ...
        proxyLabel.text = group.proxyNodes.first?.name ?? "None".localized()
    ...
    lazy var nameLabel: UILabel = {
        let v = UILabel()
        v.textColor = AppColor.TextPrimary
    ...
    lazy var proxyLabel: UILabel = {
        let v = UILabel()
        v.textColor = AppColor.TextSecond
