...
//  SSR-Pro
//
//  Created by Tahir M. on 19/10/2023.
...
public final class Keychain {
    ...
    public var protocolType: kProtocolType {
    ...
    public convenience init(server: String, protocolType: kProtocolType, authenticationType: AuthenticationType = .default) {
        self.init(server: URL(string: server)!, protocolType: protocolType, authenticationType: authenticationType)
    }
    
    public convenience init(server: URL, protocolType: kProtocolType, authenticationType: AuthenticationType = .default) {
        var options = Options()
            ...
            switch itemClass {
                ...
                case .internetPassword:
                    ...
                    if let proto = attributes[AttributeProtocol] as? String {
                        if let protocolType = kProtocolType(rawValue: proto) {
...
struct Options {
    ...
    var server: URL!
    var protocolType: kProtocolType!
...
extension kProtocolType: RawRepresentable, CustomStringConvertible {
